            ...
            <div className='home-page pb-12'>
                <div className="home-content">
                    ...
                    <div className="max-w-[1200px] mx-auto mt-6">
                        {/* ICEMAN IS DRAKE */}
                        <div className='iceman-drake px-6 py-4'>
                            <h2 className="text-xs sm:text-sm text-zinc-400 font-extrabold tracking-widest mb-3 text-left">ICEMAN IS DRAKE</h2>
                            <div className="w-full p-6 bg-gradient-to-r from-zinc-950/80 via-black/40 to-zinc-950/80 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl">
                                <div className="flex flex-col md:flex-row gap-8 items-center justify-between">
                                    
                                    {/* The 3 Albums List */}
                                    <div className="flex gap-6 overflow-x-auto py-2 no-scrollbar scroll-smooth flex-1">
                                        {[
                                            { id: '0OAv7DCME2AV4q1KPO95HY', name: 'ICEMAN', artist: 'Drake', cover: 'https://i.scdn.co/image/ab67616d0000b273fe9d3ab9adb1d3b59835b81c' },
                                            { id: '0P6B5R3yRSkhkmequL5Yno', name: 'HABIBTI', artist: 'Drake', cover: 'https://i.scdn.co/image/ab67616d0000b273b92879e45761d711016476df' },
                                            { id: '71yBvOeRZ9os9LYFEy9eOk', name: 'MAID OF HONOUR', artist: 'Drake', cover: 'https://i.scdn.co/image/ab67616d0000b273539bb112d7c970545dd971e3' }
                                        ].map((alb) => (
                                            <div 
                                                key={alb.id} 
                                                onClick={() => navigate(`/album/${alb.id}`)}
                                                className="flex-shrink-0 w-32 sm:w-36 cursor-pointer group transition-all duration-300 transform hover:scale-105 hover:-translate-y-1"
                                            >
                                                <div className="relative overflow-hidden rounded-xl shadow-lg aspect-square bg-zinc-800/80 border border-white/10 group-hover:border-[#1db954]/50 transition-colors">
                                                    <img 
                                                        src={alb.cover} 
                                                    ...
                                                    />
                                                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                                                        <span className="text-white text-[10px] font-semibold bg-[#1db954]/90 px-2.5 py-1 rounded-full shadow-md">
                                                            View Details
                                                        </span>
                                                    </div>
                                                </div>
                                                <h3 className="text-white text-xs font-bold mt-2.5 text-left truncate group-hover:text-[#1db954] transition-colors duration-200">
                                                    {alb.name}
                                                </h3>
                                                <p className="text-zinc-500 text-[10px] text-left truncate">
                                                    {alb.artist}
                                                </p>
                                            </div>
                                        ))}
                                    ...
                                    {/* Drake's Artist Profile Card */}
                                    <div 
                                        onClick={() => navigate('/artist/3TVXtAsR1Inumwj472S9r4')}
                                        className="flex flex-col items-center justify-center bg-white/5 border border-white/10 hover:border-[#1db954]/40 rounded-2xl p-5 cursor-pointer transition-all duration-300 hover:bg-white/10 hover:scale-103 shadow-md w-full md:w-48 text-center flex-shrink-0"
                                    >
                                        <div className="w-20 h-20 rounded-full overflow-hidden border border-white/10 shadow-lg mb-3">
                                            <img 
                                        ...
                                        <h3 className="text-white text-sm font-black tracking-wide">Drake</h3>
                                        <p className="text-[#1db954] text-[10px] font-bold uppercase tracking-wider mt-1">Artist Profile</p>
                                    </div>
